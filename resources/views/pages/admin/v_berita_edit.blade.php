    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <input class="form-control @error('Judul') is-invalid @enderror" type="text" name="Judul" value="{{ old('Judul', $EditBerita->judul_berita) }}" id="Judul" @error('Judul') aria-describedby="JudulFeedback" @enderror required>
                @error('Judul')
        ...
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <textarea class="form-control @error('Isi') is-invalid @enderror" id="Isi" name="Isi" @error('Isi') aria-describedby="IsiFeedback" @enderror>{{ old('Isi', $EditBerita->isi_berita) }}</textarea>
                @error('Isi')
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <input class="form-control" name="penulis" value="{{ $EditBerita->penulis_berita }}" id="Nama-Pengguna" readonly style="cursor: not-allowed">
            </div>
        </div>
