...
<main>
    ...
    <div class="container">
        <div class="text-center pt-4">
            <h1><strong>Daftar Guru dan Pegawai</strong></h1>
        </div>
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4 pt-3 ">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12" data-aos="fade-up" data-aos-duration="3000" data-aos-easing="ease">
                <div class="card shadow mb-4 text-center " style="border-color: #0bc15e; border-radius: 25px; border-width: 3px;">
                    <img src="{{  url('') }}/img/foto/pegawai/{{ $P->foto_pegawai }}" class="card-img-top" alt="..." style="border-radius: 25px; margin: 17px 17px 0px 17px; width: auto; height: auto;">
                    <div class="card-body">
                        <h5 class="card-title" style="text-decoration-color: #0bc15e;">{{ $P->nama_pegawai }}</h5>
                        <p class="card-text text-center">{{ $P->jabatan_pegawai }}</p>
                    </div>
                </div>
            </div>
            @endforeach
